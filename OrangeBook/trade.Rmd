...
```{r missing_quantity_props_per_country, cache = F, fig.width = 4, fig.height = 4}
...
```{r other_partners_of_jp, results = "asis"}
tmp_tbl <- orange %>%
  filter(partner_name == "Japan" &
           #hs6 == "041000" &
           year == "2011" &
           flow == "Import" &
           weight <= 50 & weight > 30 &
           value <= 27000 & value > 10000) %>% collect() #%>% 
#     select(year, 
#          partner_name, 
#          weight,
#          value,

...
printDistributionTable(toPrint)
```
...
**ADD BALANCING HERE (and delete the little R chunk below which sets food manually)**
```{r, echo = FALSE}
invisible(wheatData[measuredItemCPC == "0111" & timePointYears == "2011" & element == "5141",
          Value := 26278543])
```

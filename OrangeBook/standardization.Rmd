...
distributionTable = toPrint[measuredItemCPC %in% c(flourCode, bulgurCode,
                            ...
                            list(measuredItemCPC, Value_measuredElement_5510)]
setnames(distributionTable, c("Item", "prodMean"))
...
```{r, echo = FALSE}
toPrint[measuredItemCPC == bulgurCode, Value_measuredElement_5510 := 
```

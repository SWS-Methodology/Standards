...
# TO DO
- Finish up the standardization: resolve the bran/germ issue with weights (probably 0 for bran and germ).
...
temp = rollUpFood(data = wheatData, tree = tree, standParams = params)
toPrint = wheatData[geographicAreaM49 == currentCountry &
                        timePointYears == currentYear, ]
...
toPrint[, updateFlag := element == params$foodCode & measuredItemCPC == starchCode]
printTable(toPrint, params)
})})
```

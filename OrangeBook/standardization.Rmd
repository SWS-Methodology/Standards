...
## Molasses to sugar beet and sugar cane
tree[childID == "23540", extractionRate := 0.10]
...
## Beet pulp to sugar beet
tree[parentID == "01801" & childID == "39140.01", extractionRate := 0.05]
## Bagasse to sugar cane
tree[parentID == "01802" & childID == "39140.02", extractionRate := 0.05]
## Gluten to flour
...
nutrient = fread(paste0(workingDir, "nutrientData.csv"),
                 colClasses = c(rep("character", 6), "numeric"))
nutrient = nutrient[, c("measuredItemCPC", "Nutrient", "Value"), with = FALSE]
nutrient[, measuredItemCPC]

toPrint = wheatData[timePointYears == "2011" & element == params$foodCode, ]
toPrint = merge(toPrint, nutrient, by = params$itemVar)

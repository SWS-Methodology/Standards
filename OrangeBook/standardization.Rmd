...
After balancing the above tables, we're left with the following values.  Note that only food processing is the element that receives most of the adjustment because it has a substantially higher variability.

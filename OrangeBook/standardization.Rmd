...
Note that in this case, the standard deviation for food for processing is very large compared to all other elements and thus this element takes the majority of the difference.
...
toPrint[, balancedValue := balancing(param1 = sapply(Value, na2zero),
              ...
              optimize = "constrOptim", constrTol = 1e-4)]
sink()
